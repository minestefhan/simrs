...
Lokasi project frontend/socket/kiosk/viewer/ereservasi: **/opt/project/**  
Lokasi backend Laravel: **/service**  
Port aplikasi:
- Frontend Typescript JS: **2222**
- Socket.io: **2223**
- Kiosk Angular: **2224**
- Viewer: **2225**
- E-Reservasi: **2226**
- Backend: **PHP-FPM 7.4 (Laravel)**
...
> **Dihapus sesuai permintaan** — tidak ada instalasi MongoDB maupun driver MongoDB.
...
```nginx name=/etc/nginx/nginx.conf
user user-project;
...
```nginx name=/etc/nginx/conf.d/default.conf
server {
    listen 80;
    ...
    location /frontend/ { proxy_pass http://127.0.0.1:2222/; }
    location /socket/   { proxy_pass http://127.0.0.1:2223/; }
    location /kiosk/    { proxy_pass http://127.0.0.1:2224/; }
    location /viewer/   { proxy_pass http://127.0.0.1:2225/; }
    location /ereservasi/ { proxy_pass http://127.0.0.1:2226/; }
}
```
